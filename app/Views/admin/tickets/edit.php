        ...
        <form action="<?= base_url('tickets/'.$ticket['id']) ?>" method="post">
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        ...
                        <input class="form-control <?php if ($validation->getError('title')): ?>is-invalid<?php endif; ?>" required
            ...
            <div class="row">
                <div class="col">
                    ...
                    <textarea name="description" class="form-control" id="" cols="30" rows="3"><?php echo $ticket['description'] ?></textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="url" name="url" id="exampleInputBorderWidth2" value="<?php if($ticket['url']): echo $ticket['url']; else: echo ''; endif ?>">
                    </div>
                </div>
            </div>
