...
<div>
    <div class="card">
        ...
        <div class="card-footer">
            <!-- <a href="<?= base_url('/admin/tickets/'.$ticket['id']) ?>" class="btn btn-sm btn-light mx-1" title="Ver"><span class="fas fa-eye"><span></a> -->
            <a href="<?= base_url('/admin/tickets/'.$ticket['id'].'/edit') ?>" class="btn btn-sm btn-light"><span class="fas fa-edit"><span></a>
